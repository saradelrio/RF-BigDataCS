...
public class InMemBuilder extends Builder {
  ...
  public InMemBuilder(TreeBuilder treeBuilder, Path dataPath, Path datasetPath, Long seed, Configuration conf, int npos, int nneg, int size) {
    super(treeBuilder, dataPath, datasetPath, seed, conf, npos, nneg, size);
  }
  
  public InMemBuilder(TreeBuilder treeBuilder, Path dataPath, Path datasetPath, int npos, int nneg, int size) {
    this(treeBuilder, dataPath, datasetPath, null, new Configuration(), npos, nneg, size);
  }
