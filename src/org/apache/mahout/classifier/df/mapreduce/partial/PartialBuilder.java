...
public class PartialBuilder extends Builder {
  ...
  public PartialBuilder(TreeBuilder treeBuilder, Path dataPath, Path datasetPath, Long seed, int npos, int nneg, int size) {
    this(treeBuilder, dataPath, datasetPath, seed, new Configuration(), npos, nneg, size);
  }
